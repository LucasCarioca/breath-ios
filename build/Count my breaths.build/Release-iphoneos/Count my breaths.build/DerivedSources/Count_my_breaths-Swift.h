...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Count_my_breaths",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16Count_my_breaths11AppDelegate")
...
SWIFT_CLASS_NAMED("CountRecord")
@interface CountRecord : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface CountRecord (SWIFT_EXTENSION(Count_my_breaths))
@property (nonatomic) int16_t beats;
@property (nonatomic) int16_t elapsedTime;
...
SWIFT_CLASS("_TtC16Count_my_breaths13SceneDelegate")
